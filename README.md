...
A Claude Code plugin for scheduling and publishing social media posts across 11 platforms via [Simplified.com](https://simplified.com).
...
- **Compose** posts with text, media, hashtags, mentions, and platform-specific settings
- **Publish** — schedule at a specific time, add to your auto-schedule queue, or save as draft

## Supported Platforms

Facebook, Instagram, TikTok, YouTube, LinkedIn, Pinterest, Threads, Google Business Profile, Bluesky, Twitter/X, TikTok Business
...
|------------------------|--------------------------------------|---------------------------------------|
| `SIMPLIFIED_API_TOKEN` | Your Simplified API token            | simplified.com → Settings → API       |
| `SIMPLIFIED_ORG_ID`    | Your Simplified organization ID      | simplified.com → Settings → Organization |

```bash
export SIMPLIFIED_API_TOKEN="your-api-token"
export SIMPLIFIED_ORG_ID="your-org-id"
```
...
> "Post 'Just shipped v2.0!' to our Instagram and Twitter accounts"
